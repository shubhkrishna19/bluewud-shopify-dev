...
| **E-02** | **"Check Pincode" Widget** | [ ] Open | High | Real-time serviceability check input below price. (Mock Data for now). |
...
| :--- | :--- | :--- | :--- | :--- |
| **F-01** | **Mobile Bottom Navigation** | [ ] Open | High | App-like bottom nav: Home | Categories | Wishlist | Cart | Account. |
| **F-02** | **Search Overlay Polish** | [ ] Open | Med | Full-screen search overlay with "Trending Searches" and "Popular Products". |
| **F-03** | **Product Card Badges** | [ ] Open | Low | "Best Seller", "New Arrival", "50% OFF" badges with correct WS styling. |

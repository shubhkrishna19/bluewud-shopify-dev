...
- **2026-01-25 (Antigravity)**: **EMERGENCY FIX DEPLOYED.** Detected and stripped massive git merge conflict markers from `theme.liquid` and `woodenstreet-master.css` that were causing "slop state". Restored site functionality.
